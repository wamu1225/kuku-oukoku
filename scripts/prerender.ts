...
<p>当サイトはGoogle AdSenseによる広告を配信する場合があります。Googleを含む第三者配信事業者は、Cookieを使用して過去のアクセス情報をもとに広告を配信します。</p>`,
  ...
  },
  {
    slug: 'collection',
    title: 'ずかん | 九九おうこく',
    description: '集めた賢者の印・王国の秘宝・挑戦のメダル・探索の証など41種類のコレクション一覧。',
    ogType: 'article', changefreq: 'monthly', priority: '0.6',
    breadcrumbName: 'ずかん',
    fallbackHtml: `<h1>ずかん</h1><p>九九おうこくでは、段位の印20種、王国の秘宝11種、挑戦のメダル4種、探索の証6種の合計41種類のコレクションがあります。条件を達成すると自動的に獲得され、ずかんに記録されます。すべてを集めると「究極の玉座」がもらえます。</p><p><a href="/kuku-oukoku/">← ホーム</a></p>`,
  },
  {
    slug: 'calendar',
