...
<p>当サイトはGoogle AdSenseによる広告を配信する場合があります。Googleを含む第三者配信事業者は、Cookieを使用して過去のアクセス情報をもとに広告を配信します。</p>`,
  ...
  },
  {
    slug: 'map',
    title: '九九の地図 | 九九おうこく',
    description: '1×1 から 9×9 までの全体表をひと目で見渡せるページ。マスターした段はハイライト表示。',
    ogType: 'article', changefreq: 'monthly', priority: '0.6',
    breadcrumbName: '九九の地図',
    fallbackHtml: `<h1>九九の地図</h1><p>1×1 から 9×9 までの 81 マスを一覧できる全体表です。まなぶ・アタック・だんいにんていでマスターした段はハイライト表示されます。九九を視覚的に俯瞰したいとき、九九表として印刷代わりに使うのもおすすめです。</p><p><a href="/kuku-oukoku/">← ホーム</a></p>`,
  },
  {
    slug: 'collection',
    title: 'ずかん | 九九おうこく',
