...
<h2>6. 「暗黒の試練」と二桁九九</h2>
<p>9の段のなかまを呼ぶと「おうこく」内に「暗黒の試練の門」が現れます。30秒で全問正解すると5,000 KPと10の段が解放され、二桁九九（11〜20の段）への道が開けます。だんいにんていで初段〜十段に合格すると、まなぶ・アタックでも10〜20の段が順次プレイ可能になります。</p>
...
const GUIDE_HOWTO_JSONLD = {
  ...
  step: [
    ...
    { '@type': 'HowToStep', position: 6, name: '暗黒の試練で二桁九九解放', text: '9の段のなかまを呼ぶと現れる試練。クリアで11〜20の段への道が開きます。' },
    { '@type': 'HowToStep', position: 7, name: 'ずかん・カレンダーで成果確認', text: '集めたメダルや連続学習日数を確認してモチベを維持します。' },
  ],
};
...
const PAGES: Page[] = [
  {
    ...
    description:
      '小学2年生向けの九九学習ゲーム。問題を解くたびにKPがたまり、なかまが集まり、おうこくが大きくなる。広告なし・追加課金なし・登録不要の安心設計。',
    ogType: 'website',
    changefreq: 'weekly',
    priority: '1.0',
  ...
  },
  {
    ...
    description: '九九おうこくのコンセプトと運営方針、動作環境、対象ユーザーについて。広告なし・追加課金なし・データはブラウザ内に保存。',
    ogType: 'article',
    changefreq: 'monthly',
    priority: '0.6',
...
<p>当サイトはGoogle AdSenseによる広告を配信する場合があります。Googleを含む第三者配信事業者は、Cookieを使用して過去のアクセス情報をもとに広告を配信します。</p>`,
  ...
  },
  {
    ...
    fallbackHtml: `<h1>だんいにんてい</h1><p>15問を制限時間90秒以内に全問正解すると合格となる段位認定モードです。10級（1の段）から始まり、級が上がるごとに範囲が広がります。1級は1〜9の段ランダム、初段以降は10、11…と二桁九九に。名人は1〜20の段から50問、伝説は100問。</p><p>合格するとずかんに「○の段の印」が記録され、おうこくのなかまの生産力が×2にアップします。</p><p><a href="/kuku-oukoku/">← ホーム</a></p>`,
  },
  {
    slug: 'battle',
    title: '九九バトル | 九九おうこく',
    description: '30秒で敵HPに一致する2枚カードの組み合わせを選んで撃破。コンボでメダル獲得。3ステージ展開。',
    ogType: 'article', changefreq: 'monthly', priority: '0.7',
    breadcrumbName: 'バトル',
    fallbackHtml: `<h1>九九バトル</h1><p>30秒のあいだ、5枚のカードから2枚を選び、その積が敵のHPと一致したら撃破できるカードバトルモードです。連続撃破でコンボが増え、20体撃破で「勇気の大剣」メダル、100体で「伝説の王者」メダルがもらえます。10級合格で「はじまりの草原」、7級合格で「しずかな森」、4級合格で「ゴツゴツ洞窟」が解放されます。</p><p><a href="/kuku-oukoku/">← ホーム</a></p>`,
  },
  {
    slug: 'tower',
    title: '九九のタワー | 九九おうこく',
  ...
  },
  {
    slug: 'trial',
    title: '暗黒の試練 | 九九おうこく',
    description: '9 の段のなかまの加護を得たプレイヤーに開かれる高難度チャレンジ。30 秒で 20 問全問正解で 10 の段が解禁。',
    ogType: 'article', changefreq: 'monthly', priority: '0.7',
    breadcrumbName: '暗黒の試練',
    fallbackHtml: `<h1>暗黒の試練</h1><p>おうこくの奥にひっそりと立つ、いにしえの門。9 の段のなかまを 1 人以上招待すると挑戦できる、九九の真の力を試される高難度チャレンジです。1×1〜9×9 から 20 問がランダムに出題され、制限時間 30 秒以内に全問正解で勝利。クリアで 5,000 KP と 10 の段が「まなぶ」「アタック」「おうこく」で解禁され、11〜20 の段の伝説のなかま招待への道が開きます。「暗黒の盾」のメダルもゲットできます。</p><p><a href="/kuku-oukoku/empire/">← おうこくへ</a></p>`,
  },
  {
    slug: 'map',
    title: '九九の地図 | 九九おうこく',
    description: '1×1から9×9までの全体表。マスターした段はハイライト表示。暗黒の試練クリアで20×20表に拡張。',
    ogType: 'article', changefreq: 'monthly', priority: '0.6',
    breadcrumbName: '九九の地図',
    fallbackHtml: `<h1>九九の地図</h1><p>1×1から9×9までの81マスを一覧できる全体表です。まなぶ・アタック・だんいにんていでクリアした段はハイライトされます。「暗黒の試練」をクリアすると、20×20の400マス「でんせつの九九の地図」に拡張されます。九九を視覚的に俯瞰したいとき、九九表として印刷代わりに使うのもおすすめです。</p><p><a href="/kuku-oukoku/">← ホーム</a></p>`,
  },
  {
    slug: 'collection',
    title: 'ずかん | 九九おうこく',
