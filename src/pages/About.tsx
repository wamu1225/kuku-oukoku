  ...
  return (
    <div className="screen content-page">
      ...
      <p>
        ...
        完全無料のブラウザ向け学習ゲームです。登録も不要で、Google AdSense による広告は
        運営費の補助としてのみ控えめに表示しています。お子さんが安心して遊べる環境を提供します。
      </p>
      ...
      <ul>
        ...
        <li>
          <strong>安心・安全</strong>：個人情報を求める機能はありません。
          学習データはすべて、お使いの端末のブラウザ内に保存されます（サーバには送信しません）。
          広告は Google AdSense のみ、控えめに表示しています。
        </li>
        <li>
