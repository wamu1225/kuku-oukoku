...
export const COLLECTION_ITEMS: CollectionItem[] = [
  ...
  { id: 'seal_10', name: '10の段の印', desc: '10の段をマスターした証', category: 'seal', emoji: '📜', color: '#a78bfa', hidden: true },
  { id: 'seal_11', name: '11の段の印', desc: '11の段をマスターした証', category: 'seal', emoji: '📜', color: '#a78bfa', hidden: true },
  { id: 'seal_12', name: '12の段の印', desc: '12の段をマスターした証', category: 'seal', emoji: '📜', color: '#a78bfa', hidden: true },
  { id: 'seal_13', name: '13の段の印', desc: '13の段をマスターした証', category: 'seal', emoji: '📜', color: '#a78bfa', hidden: true },
  { id: 'seal_14', name: '14の段の印', desc: '14の段をマスターした証', category: 'seal', emoji: '📜', color: '#a78bfa', hidden: true },
  { id: 'seal_15', name: '15の段の印', desc: '15の段をマスターした証', category: 'seal', emoji: '📜', color: '#a78bfa', hidden: true },
  { id: 'seal_16', name: '16の段の印', desc: '16の段をマスターした証', category: 'seal', emoji: '📜', color: '#a78bfa', hidden: true },
  { id: 'seal_17', name: '17の段の印', desc: '17の段をマスターした証', category: 'seal', emoji: '📜', color: '#a78bfa', hidden: true },
  { id: 'seal_18', name: '18の段の印', desc: '18の段をマスターした証', category: 'seal', emoji: '📜', color: '#a78bfa', hidden: true },
  { id: 'seal_19', name: '19の段の印', desc: '19の段をマスターした証', category: 'seal', emoji: '📜', color: '#a78bfa', hidden: true },
  { id: 'seal_20', name: '20の段の印', desc: '九九の神域に達した証', category: 'seal', emoji: '👑', color: '#fbbf24', hidden: true },
